...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ extt[oggle] extu[pdate] feedkeys fk fini[sh] flashplay flp flashstop fls
    \ flashtoggle flt fo[rward] fw frameo[nly] ha[rdcopy] h[elp] helpa[ll]
    ...
    \ qmarks q[uit] quita[ll] qa[ll] redr[aw] reg[isters] reh[ash] re[load]
...
syn keyword pentadactylOption activate act altwildmode awim autocomplete au
    ...
    \ extendedhinttags eht fbwhitelist fbw fileencoding fenc findcase fc
    ...
    \ iskeyword isk jumptags jt linenumbers ln loadplugins lpl mapleader ml
    \ maxitems messages msgs newtab nextpattern noscript-forbid nsf
    \ noscript-list nsl noscript-objects nso noscript-sites nss
    \ noscript-tempsites nst noscript-untrusted nsu pageinfo pa passkeys pk
    \ passunknown pu popups pps previouspattern runtimepath rtp sanitizeitems si
    \ sanitizeshutdown ss sanitizetimespan sts scroll scr scrollsteps scs
    \ scrolltime sct shell sh shellcmdflag shcf showmode smd showstatuslinks
    \ ssli showtabline stal spelllang spl strictfocus sf suggestengines tabclose
    \ tc tabopen to timeoutlen tmol titlestring urlseparator urlsep us useragent
    \ ua verbose vbs wildanchor wia wildcase wic wildignore wig wildmode wim
    \ wildsort wis wordseparators wsp yankshort ys
...
let s:toggleOptions = ["banghist", "bh", "errorbells", "eb", "exrc", "ex",
    ...
    \ "pornmode", "script", "timeout", "tmo", "usermode", "um", "visualbell",
    \ "vb"]
