...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/trevorj/.eclipse/eclipse-SDK-4.2RC4-linux-gtk-x86_64/plugins/org.eclim_2.2.5'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/trevorj/.eclipse/eclipse-SDK-4.2RC4-linux-gtk-x86_64'
  if has('win32unix')
