...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/trevorj/.eclipse/Aptana_Studio_3_Setup_Linux_x86_64_3.1.3/plugins/org.eclim_1.7.6'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/trevorj/.eclipse/Aptana_Studio_3_Setup_Linux_x86_64_3.1.3'
  if has('win32unix')
